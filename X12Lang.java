/* Generated By:JavaCC: Do not edit this line. X12Lang.java */
import java.util.*;
import java.io.*;

public class X12Lang implements X12LangConstants {
  ...
  final public void parse(Map<String, Object> env) throws ParseException {
    imports(env);
    statements(env);
    label_1:
    while (true) {
  ...
  final public void imports(Map<String, Object> env) throws ParseException {
                                         Token t;
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
...
//todo implement flexible statements
  final public void statements(Map<String, Object> env) throws ParseException {
    declarations(env);
    assignments(env);
    commands(env);
  }

  final public void declarations(Map<String, Object> env) throws ParseException {
                                              Token token;
    label_3:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public Object parseValue(String key, Token token) throws ParseException {
                switch(key) {
                        case "int":
  ...
  final public void assignments(Map<String, Object> env) throws ParseException {
                                             Token token, value; String key;
    label_4:
    while (true) {
      if (jj_2_1(2)) {
        ;
  ...
  final public void commands(Map<String, Object> env) throws ParseException {
                                          Token token; Object var;
    label_5:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case PRV:
  ...
  public X12LangTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4,0x200,0x1000,0x1e000,0xf000000,0x800,0xf000000,0x1f000000,};
   }
  ...
  public X12Lang(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public X12Lang(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new X12LangTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public X12Lang(java.io.Reader stream) {
  ...
  public X12Lang(X12LangTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(X12LangTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
